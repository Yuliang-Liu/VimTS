...
class COCOVisualizer():
    ...
    def visualize(self, img, tgt, caption=None, dpi=300, savedir=None, show_in_console=True):
        ...
        if savedir is not None:
            ...
            savename = '{}/{}.png'.format(savedir, str(tgt['image_name']))
    ...
    def addtgt(self, tgt):
        ...
        if 'box_label' in tgt:
            ...
            for idx, bl in enumerate(tgt['box_label']):
                ...
                ax.text(p1, p2, _string, color='white', bbox={'facecolor': [0,0,0], 'alpha': 0.6, 'pad': 2},fontproperties=prop,)
