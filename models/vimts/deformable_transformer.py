...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, refpoint_embed, pos_embeds, tgt, attn_mask=None, H=None, W=None, rec_embed=None, prompt_feat=None):
        """
        Input:
        ...
        src_flatten = torch.cat(src_flatten, 1) + prompt_feat   # bs, \sum{hxw}, c 
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, 
        ...
        for layer_id, layer in enumerate(self.layers):
            ...
            output = self.adapter[layer_id](output)
...
class TransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, roi_features, memory,
        ...
        for layer_id, layer in enumerate(self.layers):
            ...
            output = self.adapter[layer_id](tgt = output,
                    )
            # iter update
